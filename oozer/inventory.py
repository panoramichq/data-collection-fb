...
from oozer.entities.collect_entities_task import collect_entities_per_page_post_task, collect_entities_page_posts_task
...
entity_report_handler_map = {
    ...
    ReportType.entity: {
        ...
        Entity.PagePost: collect_entities_page_posts_task,
