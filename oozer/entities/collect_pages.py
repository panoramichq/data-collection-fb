...
def collect_page_task(job_scope, job_context):
...
def collect_page(job_scope, _job_context):
    """
...
@Measure.timer(__name__, function_name_as_metric=True)
@Measure.counter(__name__, function_name_as_metric=True, count_once=True)
def collect_pages_from_business_task(job_scope, job_context):
...
def collect_pages_from_business(job_scope, _job_context):
    """
