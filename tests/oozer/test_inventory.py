...
class TestLooperReportTypeInventoryResolution(TestCase):
    ...
    def test_resolve_job_scope_to_celery_task_ad_account(self, mock_lifetime_iter, mock_breakdowns_iter):
        real_claim = RealityClaim(
            entity_id='A1', ad_account_id='A1', entity_type=Entity.AdAccount, timezone='America/Los_Angeles'
        )
    ...
    def test_resolve_job_scope_to_celery_task_page(self):
        real_claim = RealityClaim(
            entity_id='P1', ad_account_id='P1', entity_type=Entity.Page, timezone='America/Los_Angeles'
        )
    ...
    def test_resolve_job_scope_to_celery_task_page_post(self):
        real_claim = RealityClaim(entity_id='PP1', ad_account_id='P1', entity_type=Entity.PagePost)
    ...
    def test_resolve_job_scope_to_celery_task_page_video(self):
        real_claim = RealityClaim(entity_id='PV1', ad_account_id='P1', entity_type=Entity.PageVideo)
