...
class TestingIdParsingTools(TestCase):
    ...
    def test_fields_default_universal(self):
        ...
        id_data_actual = id_tools.parse_id(
            ...
            fields=id_tools.universal_id_fields
        )
