...
@patch('sweep_builder.expectation_builder.expectations_inventory.metrics.lifetime.iter_reality_per_ad_account_claim')
def test_lifetime_metrics_per_ads_under_ad_account_not_divisible(mock_iter_reality_per_ad_account):
    reality_claim = RealityClaim(
        ad_account_id='ad-account-id',
        entity_id='ad-account-id',
        entity_type=Entity.AdAccount,
    ...
    result = list(lifetime_metrics_per_ads_under_ad_account(reality_claim))
...
@patch('sweep_builder.expectation_builder.expectations_inventory.metrics.lifetime.iter_reality_per_ad_account_claim')
def test_lifetime_metrics_per_ads_under_ad_account_is_divisible(mock_iter_reality_per_ad_account):
    reality_claim = RealityClaim(
        ad_account_id='ad-account-id',
        entity_id='ad-account-id',
        entity_type=Entity.AdAccount,
