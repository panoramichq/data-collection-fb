...
day_metrics_per_ads_under_ad_account = partial(day_metrics_per_entity_under_ad_account, Entity.Ad)
day_metrics_per_adsets_under_ad_account = partial(day_metrics_per_entity_under_ad_account, Entity.AdSet)
day_metrics_per_campaigns_under_ad_account = partial(day_metrics_per_entity_under_ad_account, Entity.Campaign)
