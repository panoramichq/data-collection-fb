    ...
    Entity.Campaign: list(
        filter(
            ...
            [
                ...
                None if jobs_config.INSIGHTS_LIFETIME_AS_DISABLED else lifetime_metrics_per_adsets_under_ad_account,
                None if jobs_config.INSIGHTS_LIFETIME_A_DISABLED else lifetime_metrics_per_ads_under_ad_account,
                None if jobs_config.INSIGHTS_DAY_A_DISABLED else day_metrics_per_ad_per_entity,
                None if jobs_config.INSIGHTS_HOUR_A_DISABLED else hour_metrics_per_ad_per_entity,
                None if jobs_config.INSIGHTS_AGE_GENDER_A_DISABLED else day_age_gender_metrics_per_ad_per_entity,
                None if jobs_config.INSIGHTS_PLATFORM_A_DISABLED else day_platform_metrics_per_ad_per_entity,
            ],
        )
    ),
}
