...
REPORT_TYPE_ENTITY_COMMENTS_FREQUENCY = 6

# Selector Parameters
FAILS_IN_ROW_BREAKDOWN_LIMIT = 5
...
if INSIGHTS_ALL_SEGMENTED_DISABLED:
    ...
    INSIGHTS_REGION_A_DISABLED = True
    INSIGHTS_COUNTRY_A_DISABLED = True
